...
export function CaseModal({ project, open, onOpenChange }: CaseModalProps) {
  ...
  const detailSections = (
    <div className="space-y-4 text-sm sm:space-y-6">
      <div>
        <h4 className="mb-1 font-semibold text-foreground">Problema</h4>
        <p className="text-muted-foreground">{problem}</p>
      </div>
      <div>
        <h4 className="mb-1 font-semibold text-foreground">Solução técnica</h4>
        <p className="text-muted-foreground">{solution}</p>
      </div>
      <div>
        <h4 className="mb-2 font-semibold text-foreground">Stack utilizada</h4>
      ...
      <div>
        <h4 className="mb-1 font-semibold text-foreground">Resultado / Impacto</h4>
