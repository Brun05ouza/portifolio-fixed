        ...
        <div className="container-custom relative z-10 flex items-center min-h-[80vh]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
            ...
            <motion.div
              ...
              className="absolute lg:relative lg:flex justify-center items-center inset-0 lg:inset-auto opacity-20 lg:opacity-100 z-0 lg:z-10 order-1 lg:order-1"
            >
            ...
            <div className="text-white space-y-6 order-2 lg:order-2 relative z-10">
              {/* Badge */}
              <motion.div
